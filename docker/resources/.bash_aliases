...
alias ub_autoware='ros2 launch autoware_launch autoware.launch.xml sensor_model:=ub_lincoln_sensor_kit vehicle_model:=ub_lincoln_vehicle map_path:=/host_data/ub_hdmap'